<table style="width:100%">
    <tbody>
        <tr>
            <td><h4>
                Who moved my cheese? How storage systems deal with changes in their media.
            </h4> <br> <b>
                Gala Yadgar
            </b> <br> 
            Technion, Israel
            </td>
            <td width="150"><img src="speakers/yadgar.jpeg" alt="Speaker's photo" height="150"/> </td>
        </tr>
        <tr>
            <td colspan=2>
